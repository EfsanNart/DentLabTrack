...
namespace DentLabTrack.Data.Migrations
{
    ...
    partial class DentLabTrackDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentLabTrack.Data.Entities.LabTechnicianEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentLabTrack.Data.Entities.OrderEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentLabTrack.Data.Entities.PatientEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentLabTrack.Data.Entities.SettingEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentLabTrack.Data.Entities.OrderEntity", b =>
                {
                    ...
                    b.HasOne("DentLabTrack.Data.Entities.PatientEntity", "Patient")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("DentLabTrack.Data.Entities.OrderTechnician", b =>
                {
                    b.HasOne("DentLabTrack.Data.Entities.OrderEntity", "Order")
                        .WithMany("OrderTechnicians")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DentLabTrack.Data.Entities.LabTechnicianEntity", "Technician")
                        .WithMany("OrderTechnicians")
